...
public class  BuscarArchivos {
	...
	public static CharArraySet stopWords() {
		...
		//FileReader carga = new FileReader("/app/invIndex/stopwords/stopwords.txt");
	...
	public static void buscador(IndexSearcher searcher, Query query) throws IOException, JSONException{
	    ...
	    for (int i = 0; i < max; i++) {   
		    ...
		    objRespuesta.put("retweets", doc.get("indxRetweet"));
		    objRespuesta.put("photo", doc.get("photo"));
